...
function getFragmentQueryDocument(document, fragmentName) {
  ...
  var query = __assign2(__assign2({}, document), { definitions: __spreadArray([
    {
...
var Observable = function() {
  ...
  _proto3.subscribe = function subscribe3(observer) {
...
var createHttpLink = function(linkOptions) {
  ...
  var _a5 = linkOptions.uri, uri = _a5 === void 0 ? "/graphql" : _a5, preferredFetch = linkOptions.fetch, _b = linkOptions.print, print3 = _b === void 0 ? defaultPrinter : _b, includeExtensions = linkOptions.includeExtensions, useGETForQueries = linkOptions.useGETForQueries, _c = linkOptions.includeUnusedVariables, includeUnusedVariables = _c === void 0 ? false : _c, requestOptions = __rest(linkOptions, ["uri", "fetch", "print", "includeExtensions", "useGETForQueries", "includeUnusedVariables"]);
  if (__DEV__) {
  ...
  return new ApolloLink(function(operation) {
    ...
    if (context.clientAwareness) {
      var _a6 = context.clientAwareness, name_1 = _a6.name, version4 = _a6.version;
      if (name_1) {
        clientAwarenessHeaders["apollographql-client-name"] = name_1;
      }
      if (version4) {
        clientAwarenessHeaders["apollographql-client-version"] = version4;
      }
    }
...
function dep(options) {
  ...
  var subscribe3 = options && options.subscribe;
  function depend(key) {
    var parent = parentEntrySlot.getValue();
    if (parent) {
      ...
      if (typeof subscribe3 === "function") {
        maybeUnsubscribe(dep_1);
        dep_1.unsubscribe = subscribe3(key);
      }
    }
  }
...
var hasOwnProperty5 = _a4.hasOwnProperty;
...
var LocalState = function() {
  ...
  LocalState2.prototype.resolveSelectionSet = function(selectionSet, rootValue, execContext) {
    return __awaiter(this, void 0, void 0, function() {
      var fragmentMap, context, variables, resultsToMerge, execute4;
      var _this = this;
      return __generator(this, function(_a5) {
        fragmentMap = execContext.fragmentMap, context = execContext.context, variables = execContext.variables;
        resultsToMerge = [rootValue];
        execute4 = function(selection) {
        ...
        return [2, Promise.all(selectionSet.selections.map(execute4)).then(function() {
...
var QueryManager = function() {
  ...
  QueryManager2.prototype.getVariables = function(document, variables) {
    return __assign2(__assign2({}, this.transform(document).defaultVars), variables);
  };
...
// ../../node_modules/graphql-tag/node_modules/graphql/version.mjs
...
// ../../node_modules/graphql-tag/node_modules/graphql/jsutils/devAssert.mjs
...
// ../../node_modules/graphql-tag/node_modules/graphql/jsutils/isObjectLike.mjs
function isObjectLike2(value) {
  return typeof value == "object" && value !== null;
}

// ../../node_modules/graphql-tag/node_modules/graphql/jsutils/invariant.mjs
...
// ../../node_modules/graphql-tag/node_modules/graphql/language/location.mjs
var LineRegExp2 = /\r\n|[\n\r]/g;
...
// ../../node_modules/graphql-tag/node_modules/graphql/language/printLocation.mjs
function printLocation2(location) {
  return printSourceLocation2(
    location.source,
    getLocation2(location.source, location.start)
  );
}
...
// ../../node_modules/graphql-tag/node_modules/graphql/error/GraphQLError.mjs
function toNormalizedArgs2(args) {
  const firstArg = args[0];
  if (firstArg == null || "kind" in firstArg || "length" in firstArg) {
    return {
      nodes: firstArg,
...
var GraphQLError2 = class extends Error {
  constructor(message, ...rawArgs) {
    var _this$nodes, _nodeLocations$, _ref;
    const { nodes, source, positions, path, originalError, extensions } = toNormalizedArgs2(rawArgs);
    super(message);
    this.name = "GraphQLError";
    this.path = path !== null && path !== void 0 ? path : void 0;
    this.originalError = originalError !== null && originalError !== void 0 ? originalError : void 0;
    ...
    this.source = source !== null && source !== void 0 ? source : nodeLocations === null || nodeLocations === void 0 ? void 0 : (_nodeLocations$ = nodeLocations[0]) === null || _nodeLocations$ === void 0 ? void 0 : _nodeLocations$.source;
    this.positions = positions !== null && positions !== void 0 ? positions : nodeLocations === null || nodeLocations === void 0 ? void 0 : nodeLocations.map((loc) => loc.start);
    this.locations = positions && source ? positions.map((pos) => getLocation2(source, pos)) : nodeLocations === null || nodeLocations === void 0 ? void 0 : nodeLocations.map((loc) => getLocation2(loc.source, loc.start));
  ...
  toString() {
    ...
    if (this.nodes) {
      ...
      for (const location of this.locations) {
        output += "\n\n" + printSourceLocation2(this.source, location);
      }
    }
    return output;
  }
...
// ../../node_modules/graphql-tag/node_modules/graphql/error/syntaxError.mjs
function syntaxError2(source, position, description) {
  return new GraphQLError2(`Syntax Error: ${description}`, void 0, source, [
    position
  ]);
}

// ../../node_modules/graphql-tag/node_modules/graphql/language/ast.mjs
var Location2 = class {
  constructor(startToken, endToken, source) {
    this.start = startToken.start;
    this.end = endToken.end;
...
// ../../node_modules/graphql-tag/node_modules/graphql/language/directiveLocation.mjs
...
// ../../node_modules/graphql-tag/node_modules/graphql/language/kinds.mjs
var Kind2;
(function(Kind3) {
  Kind3["NAME"] = "Name";
  Kind3["DOCUMENT"] = "Document";
...
// ../../node_modules/graphql-tag/node_modules/graphql/language/characterClasses.mjs
...
// ../../node_modules/graphql-tag/node_modules/graphql/language/blockString.mjs
...
function leadingWhitespace2(str) {
  let i = 0;
  while (i < str.length && isWhiteSpace2(str.charCodeAt(i))) {
    ++i;
  }
  return i;
}
...
// ../../node_modules/graphql-tag/node_modules/graphql/language/tokenKind.mjs
var TokenKind2;
(function(TokenKind3) {
  TokenKind3["SOF"] = "<SOF>";
  TokenKind3["EOF"] = "<EOF>";
...
// ../../node_modules/graphql-tag/node_modules/graphql/language/lexer.mjs
var Lexer2 = class {
  constructor(source) {
    const startOfFileToken = new Token2(TokenKind2.SOF, 0, 0, 0, 0);
    this.source = source;
    this.lastToken = startOfFileToken;
    this.token = startOfFileToken;
    this.line = 1;
...
function isPunctuatorTokenKind2(kind) {
  return kind === TokenKind2.BANG || kind === TokenKind2.DOLLAR || kind === TokenKind2.AMP || kind === TokenKind2.PAREN_L || kind === TokenKind2.PAREN_R || kind === TokenKind2.SPREAD || kind === TokenKind2.COLON || kind === TokenKind2.EQUALS || kind === TokenKind2.AT || kind === TokenKind2.BRACKET_L || kind === TokenKind2.BRACKET_R || kind === TokenKind2.BRACE_L || kind === TokenKind2.PIPE || kind === TokenKind2.BRACE_R;
}
...
function readNextToken2(lexer, start) {
  ...
  while (position < bodyLength) {
    ...
    switch (code) {
      ...
      case 33:
        return createToken2(lexer, TokenKind2.BANG, position, position + 1);
      case 36:
        return createToken2(lexer, TokenKind2.DOLLAR, position, position + 1);
      case 38:
        return createToken2(lexer, TokenKind2.AMP, position, position + 1);
      case 40:
        return createToken2(lexer, TokenKind2.PAREN_L, position, position + 1);
      case 41:
        return createToken2(lexer, TokenKind2.PAREN_R, position, position + 1);
      case 46:
        if (body.charCodeAt(position + 1) === 46 && body.charCodeAt(position + 2) === 46) {
          return createToken2(lexer, TokenKind2.SPREAD, position, position + 3);
        }
        break;
      case 58:
        return createToken2(lexer, TokenKind2.COLON, position, position + 1);
      case 61:
        return createToken2(lexer, TokenKind2.EQUALS, position, position + 1);
      case 64:
        return createToken2(lexer, TokenKind2.AT, position, position + 1);
      case 91:
        return createToken2(lexer, TokenKind2.BRACKET_L, position, position + 1);
      case 93:
        return createToken2(lexer, TokenKind2.BRACKET_R, position, position + 1);
      case 123:
        return createToken2(lexer, TokenKind2.BRACE_L, position, position + 1);
      case 124:
        return createToken2(lexer, TokenKind2.PIPE, position, position + 1);
      case 125:
        return createToken2(lexer, TokenKind2.BRACE_R, position, position + 1);
      case 34:
        if (body.charCodeAt(position + 1) === 34 && body.charCodeAt(position + 2) === 34) {
    ...
    if (isDigit3(code) || code === 45) {
      return readNumber2(lexer, position, code);
    }
    if (isNameStart2(code)) {
  ...
  return createToken2(lexer, TokenKind2.EOF, bodyLength, bodyLength);
}
...
function readNumber2(lexer, start, firstCode) {
  ...
  return createToken2(
    lexer,
    isFloat ? TokenKind2.FLOAT : TokenKind2.INT,
    start,
    position,
    body.slice(start, position)
  );
...
function readDigits2(lexer, start, firstCode) {
  ...
  const body = lexer.source.body;
  let position = start + 1;
  while (isDigit3(body.charCodeAt(position))) {
    ++position;
  }
  return position;
}
function readString2(lexer, start) {
  ...
  while (position < bodyLength) {
    ...
    if (code === 34) {
      value += body.slice(chunkStart, position);
      return createToken2(lexer, TokenKind2.STRING, start, position + 1, value);
    }
    if (code === 92) {
      value += body.slice(chunkStart, position);
  ...
  while (position < bodyLength) {
    ...
    if (code === 34 && body.charCodeAt(position + 1) === 34 && body.charCodeAt(position + 2) === 34) {
      ...
      const token = createToken2(
        lexer,
        TokenKind2.BLOCK_STRING,
        start,
        position + 3,
        dedentBlockStringLines2(blockLines).join("\n")
      );
      lexer.line += blockLines.length - 1;
      lexer.lineStart = lineStart;
      return token;
...
// ../../node_modules/graphql-tag/node_modules/graphql/jsutils/inspect.mjs
...
// ../../node_modules/graphql-tag/node_modules/graphql/jsutils/instanceOf.mjs
var instanceOf4 = false ? function instanceOf5(value, constructor) {
  return value instanceof constructor;
} : function instanceOf6(value, constructor) {
  if (value instanceof constructor) {
    return true;
  }
  if (typeof value === "object" && value !== null) {
...
// ../../node_modules/graphql-tag/node_modules/graphql/language/source.mjs
var Source2 = class {
  constructor(body, name = "GraphQL request", locationOffset = {
    line: 1,
    column: 1
  }) {
    typeof body === "string" || devAssert2(false, `Body must be a string. Received: ${inspect2(body)}.`);
    this.body = body;
    this.name = name;
    this.locationOffset = locationOffset;
    this.locationOffset.line > 0 || devAssert2(
      false,
      "line in locationOffset is 1-indexed and must be positive."
    );
    this.locationOffset.column > 0 || devAssert2(
      false,
      "column in locationOffset is 1-indexed and must be positive."
    );
  }
...
function isSource2(source) {
  return instanceOf4(source, Source2);
}

// ../../node_modules/graphql-tag/node_modules/graphql/language/parser.mjs
...
var Parser = class {
  constructor(source, options) {
    const sourceObj = isSource2(source) ? source : new Source2(source);
    this._lexer = new Lexer2(sourceObj);
    this._options = options;
  }
  parseName() {
    const token = this.expectToken(TokenKind2.NAME);
  ...
  parseDefinition() {
    if (this.peek(TokenKind2.BRACE_L)) {
      return this.parseOperationDefinition();
    }
    const hasDescription = this.peekDescription();
    const keywordToken = hasDescription ? this._lexer.lookahead() : this._lexer.token;
    if (keywordToken.kind === TokenKind2.NAME) {
  ...
  parseOperationDefinition() {
    ...
    if (this.peek(TokenKind2.BRACE_L)) {
      return this.node(start, {
        ...
        operation: OperationTypeNode2.QUERY,
        name: void 0,
        variableDefinitions: [],
        directives: [],
  ...
  parseOperationType() {
    const operationToken = this.expectToken(TokenKind2.NAME);
    switch (operationToken.value) {
      case "query":
        return OperationTypeNode2.QUERY;
      case "mutation":
        return OperationTypeNode2.MUTATION;
      case "subscription":
        return OperationTypeNode2.SUBSCRIPTION;
    }
  ...
  parseVariableDefinition() {
    return this.node(this._lexer.token, {
      ...
      type: (this.expectToken(TokenKind2.COLON), this.parseTypeReference()),
      defaultValue: this.expectOptionalToken(TokenKind2.EQUALS) ? this.parseConstValueLiteral() : void 0,
      directives: this.parseConstDirectives()
    });
  }
  parseVariable() {
    const start = this._lexer.token;
    this.expectToken(TokenKind2.DOLLAR);
    return this.node(start, {
      kind: Kind2.VARIABLE,
      name: this.parseName()
    });
  ...
  parseSelection() {
    return this.peek(TokenKind2.SPREAD) ? this.parseFragment() : this.parseField();
  }
  parseField() {
    const start = this._lexer.token;
    ...
    let alias;
    let name;
    if (this.expectOptionalToken(TokenKind2.COLON)) {
      alias = nameOrAlias;
      name = this.parseName();
    } else {
      name = nameOrAlias;
    ...
    return this.node(start, {
      ...
      directives: this.parseDirectives(false),
      selectionSet: this.peek(TokenKind2.BRACE_L) ? this.parseSelectionSet() : void 0
    });
  }
  parseArguments(isConst) {
    const item = isConst ? this.parseConstArgument : this.parseArgument;
    return this.optionalMany(TokenKind2.PAREN_L, item, TokenKind2.PAREN_R);
  }
  parseArgument(isConst = false) {
    const start = this._lexer.token;
    const name = this.parseName();
    this.expectToken(TokenKind2.COLON);
    return this.node(start, {
      kind: Kind2.ARGUMENT,
      name,
  ...
  parseFragment() {
    const start = this._lexer.token;
    this.expectToken(TokenKind2.SPREAD);
    const hasTypeCondition = this.expectOptionalKeyword("on");
    if (!hasTypeCondition && this.peek(TokenKind2.NAME)) {
      return this.node(start, {
  ...
  parseValueLiteral(isConst) {
    ...
    switch (token.kind) {
      case TokenKind2.BRACKET_L:
        return this.parseList(isConst);
      case TokenKind2.BRACE_L:
      ...
      case TokenKind2.FLOAT:
        this._lexer.advance();
        return this.node(token, {
          kind: Kind2.FLOAT,
          value: token.value
        });
      case TokenKind2.STRING:
      case TokenKind2.BLOCK_STRING:
        return this.parseStringLiteral();
      case TokenKind2.NAME:
        this._lexer.advance();
        switch (token.value) {
          case "true":
            return this.node(token, {
      ...
      case TokenKind2.DOLLAR:
        if (isConst) {
          this.expectToken(TokenKind2.DOLLAR);
          if (this._lexer.token.kind === TokenKind2.NAME) {
  ...
  parseStringLiteral() {
    ...
    return this.node(token, {
      kind: Kind2.STRING,
      value: token.value,
      block: token.kind === TokenKind2.BLOCK_STRING
    });
  }
  parseList(isConst) {
    ...
    return this.node(this._lexer.token, {
      kind: Kind2.LIST,
      values: this.any(TokenKind2.BRACKET_L, item, TokenKind2.BRACKET_R)
    });
  }
  parseObject(isConst) {
    ...
    return this.node(this._lexer.token, {
      kind: Kind2.OBJECT,
      fields: this.any(TokenKind2.BRACE_L, item, TokenKind2.BRACE_R)
    });
  }
  ...
  parseDirective(isConst) {
    const start = this._lexer.token;
    this.expectToken(TokenKind2.AT);
    return this.node(start, {
  ...
  parseTypeReference() {
    const start = this._lexer.token;
    let type;
    if (this.expectOptionalToken(TokenKind2.BRACKET_L)) {
      const innerType = this.parseTypeReference();
      this.expectToken(TokenKind2.BRACKET_R);
    ...
    if (this.expectOptionalToken(TokenKind2.BANG)) {
      return this.node(start, {
  ...
  peekDescription() {
    return this.peek(TokenKind2.STRING) || this.peek(TokenKind2.BLOCK_STRING);
  }
  parseDescription() {
  ...
  parseImplementsInterfaces() {
    return this.expectOptionalKeyword("implements") ? this.delimitedMany(TokenKind2.AMP, this.parseNamedType) : [];
  }
  ...
  parseInputValueDef() {
    ...
    const type = this.parseTypeReference();
    let defaultValue;
    if (this.expectOptionalToken(TokenKind2.EQUALS)) {
  ...
  parseUnionMemberTypes() {
    return this.expectOptionalToken(TokenKind2.EQUALS) ? this.delimitedMany(TokenKind2.PIPE, this.parseNamedType) : [];
  }
  ...
  parseDirectiveLocations() {
    return this.delimitedMany(TokenKind2.PIPE, this.parseDirectiveLocation);
  }
  ...
  expectKeyword(value) {
    const token = this._lexer.token;
    if (token.kind === TokenKind2.NAME && token.value === value) {
      this._lexer.advance();
    } else {
      throw syntaxError2(
        this._lexer.source,
...
function getTokenKindDesc(kind) {
  return isPunctuatorTokenKind2(kind) ? `"${kind}"` : kind;
}

// ../../node_modules/graphql-tag/node_modules/graphql/jsutils/didYouMean.mjs
...
// ../../node_modules/graphql-tag/node_modules/graphql/jsutils/identityFunc.mjs
function identityFunc2(x) {
  return x;
}

// ../../node_modules/graphql-tag/node_modules/graphql/jsutils/keyMap.mjs
...
// ../../node_modules/graphql-tag/node_modules/graphql/jsutils/keyValMap.mjs
...
// ../../node_modules/graphql-tag/node_modules/graphql/jsutils/mapValue.mjs
...
// ../../node_modules/graphql-tag/node_modules/graphql/jsutils/naturalCompare.mjs
function naturalCompare2(aStr, bStr) {
  ...
  while (aIndex < aStr.length && bIndex < bStr.length) {
    let aChar = aStr.charCodeAt(aIndex);
    let bChar = bStr.charCodeAt(bIndex);
    if (isDigit4(aChar) && isDigit4(bChar)) {
      let aNum = 0;
      do {
        ++aIndex;
        aNum = aNum * 10 + aChar - DIGIT_02;
        aChar = aStr.charCodeAt(aIndex);
      } while (isDigit4(aChar) && aNum > 0);
      let bNum = 0;
      do {
        ++bIndex;
        bNum = bNum * 10 + bChar - DIGIT_02;
        bChar = bStr.charCodeAt(bIndex);
      } while (isDigit4(bChar) && bNum > 0);
      if (aNum < bNum) {
        return -1;
      }
      if (aNum > bNum) {
...
var DIGIT_02 = 48;
var DIGIT_92 = 57;
function isDigit4(code) {
  return !isNaN(code) && DIGIT_02 <= code && code <= DIGIT_92;
}

// ../../node_modules/graphql-tag/node_modules/graphql/jsutils/suggestionList.mjs
...
// ../../node_modules/graphql-tag/node_modules/graphql/jsutils/toObjMap.mjs
...
// ../../node_modules/graphql-tag/node_modules/graphql/language/printString.mjs
...
// ../../node_modules/graphql-tag/node_modules/graphql/language/visitor.mjs
var BREAK2 = Object.freeze({});
function visit2(root2, visitor, visitorKeys = QueryDocumentKeys2) {
  const enterLeaveMap = /* @__PURE__ */ new Map();
  ...
  do {
    ...
    if (!Array.isArray(node)) {
      var _enterLeaveMap$get, _enterLeaveMap$get2;
      isNode2(node) || devAssert2(false, `Invalid AST Node: ${inspect2(node)}.`);
      const visitFn = isLeaving ? (_enterLeaveMap$get = enterLeaveMap.get(node.kind)) === null || _enterLeaveMap$get === void 0 ? void 0 : _enterLeaveMap$get.leave : (_enterLeaveMap$get2 = enterLeaveMap.get(node.kind)) === null || _enterLeaveMap$get2 === void 0 ? void 0 : _enterLeaveMap$get2.enter;
      result2 = visitFn === null || visitFn === void 0 ? void 0 : visitFn.call(visitor, node, key, parent, path, ancestors);
      if (result2 === BREAK2) {
        break;
...
// ../../node_modules/graphql-tag/node_modules/graphql/language/printer.mjs
function print2(ast) {
  return visit2(ast, printDocASTReducer2);
}
...
var printDocASTReducer2 = {
  ...
  FragmentDefinition: {
    leave: ({ name, typeCondition, variableDefinitions, directives, selectionSet }) => `fragment ${name}${wrap3("(", join2(variableDefinitions, ", "), ")")} on ${typeCondition} ${wrap3("", join2(directives, " "), " ")}` + selectionSet
  },
  IntValue: {
    leave: ({ value }) => value
  },
  ...
  StringValue: {
    leave: ({ value, block: isBlockString }) => isBlockString ? printBlockString2(value) : printString2(value)
  },
  BooleanValue: {
    leave: ({ value }) => value ? "true" : "false"
  },
...
// ../../node_modules/graphql-tag/node_modules/graphql/utilities/valueFromASTUntyped.mjs
...
// ../../node_modules/graphql-tag/node_modules/graphql/type/assertName.mjs
function assertName2(name) {
  name != null || devAssert2(false, "Must provide name.");
  typeof name === "string" || devAssert2(false, "Expected name to be a string.");
  if (name.length === 0) {
    throw new GraphQLError2("Expected name to be a non-empty string.");
  }
  for (let i = 1; i < name.length; ++i) {
    if (!isNameContinue2(name.charCodeAt(i))) {
      throw new GraphQLError2(
        `Names must only contain [_a-zA-Z0-9] but "${name}" does not.`
      );
    }
  }
  if (!isNameStart2(name.charCodeAt(0))) {
    throw new GraphQLError2(
      `Names must start with [_a-zA-Z] but "${name}" does not.`
    );
  }
...
function assertEnumValueName2(name) {
  if (name === "true" || name === "false" || name === "null") {
    throw new GraphQLError2(`Enum values cannot be named: ${name}`);
  }
  return assertName2(name);
}

// ../../node_modules/graphql-tag/node_modules/graphql/type/definition.mjs
...
function isScalarType2(type) {
  return instanceOf4(type, GraphQLScalarType2);
}
function isObjectType2(type) {
  return instanceOf4(type, GraphQLObjectType2);
}
function isInterfaceType2(type) {
  return instanceOf4(type, GraphQLInterfaceType2);
}
function isUnionType2(type) {
  return instanceOf4(type, GraphQLUnionType2);
}
function isEnumType2(type) {
  return instanceOf4(type, GraphQLEnumType2);
}
function isInputObjectType2(type) {
  return instanceOf4(type, GraphQLInputObjectType2);
}
function isListType2(type) {
  return instanceOf4(type, GraphQLList2);
}
function isNonNullType2(type) {
  return instanceOf4(type, GraphQLNonNull2);
}
...
var GraphQLList2 = class {
  constructor(ofType) {
    isType2(ofType) || devAssert2(false, `Expected ${inspect2(ofType)} to be a GraphQL type.`);
    this.ofType = ofType;
  }
  get [Symbol.toStringTag]() {
    return "GraphQLList";
...
var GraphQLNonNull2 = class {
  constructor(ofType) {
    isNullableType2(ofType) || devAssert2(
      false,
      `Expected ${inspect2(ofType)} to be a GraphQL nullable type.`
    );
    this.ofType = ofType;
  }
  get [Symbol.toStringTag]() {
...
var GraphQLScalarType2 = class {
  constructor(config) {
    var _config$parseValue, _config$serialize, _config$parseLiteral, _config$extensionASTN;
    const parseValue3 = (_config$parseValue = config.parseValue) !== null && _config$parseValue !== void 0 ? _config$parseValue : identityFunc2;
    this.name = assertName2(config.name);
    this.description = config.description;
    this.specifiedByURL = config.specifiedByURL;
    this.serialize = (_config$serialize = config.serialize) !== null && _config$serialize !== void 0 ? _config$serialize : identityFunc2;
    this.parseValue = parseValue3;
    this.parseLiteral = (_config$parseLiteral = config.parseLiteral) !== null && _config$parseLiteral !== void 0 ? _config$parseLiteral : (node, variables) => parseValue3(valueFromASTUntyped2(node, variables));
    this.extensions = toObjMap2(config.extensions);
    this.astNode = config.astNode;
    this.extensionASTNodes = (_config$extensionASTN = config.extensionASTNodes) !== null && _config$extensionASTN !== void 0 ? _config$extensionASTN : [];
    config.specifiedByURL == null || typeof config.specifiedByURL === "string" || devAssert2(
      false,
      `${this.name} must provide "specifiedByURL" as a string, but got: ${inspect2(config.specifiedByURL)}.`
    );
    config.serialize == null || typeof config.serialize === "function" || devAssert2(
      false,
      `${this.name} must provide "serialize" function. If this custom Scalar is also used as an input type, ensure "parseValue" and "parseLiteral" functions are also provided.`
    );
    if (config.parseLiteral) {
      typeof config.parseValue === "function" && typeof config.parseLiteral === "function" || devAssert2(
        false,
        `${this.name} must provide both "parseValue" and "parseLiteral" functions.`
      );
    }
...
var GraphQLObjectType2 = class {
  constructor(config) {
    ...
    config.isTypeOf == null || typeof config.isTypeOf === "function" || devAssert2(
      false,
      `${this.name} must provide "isTypeOf" as a function, but got: ${inspect2(config.isTypeOf)}.`
    );
  }
  get [Symbol.toStringTag]() {
    return "GraphQLObjectType";
...
function defineInterfaces2(config) {
  ...
  Array.isArray(interfaces) || devAssert2(
    false,
    `${config.name} interfaces must be an Array or a function which returns an Array.`
  );
  return interfaces;
...
function defineFieldMap2(config) {
  ...
  isPlainObj2(fieldMap) || devAssert2(
    false,
    `${config.name} fields must be an object with field names as keys or a function which returns such an object.`
  );
  return mapValue2(fieldMap, (fieldConfig, fieldName) => {
    var _fieldConfig$args;
    isPlainObj2(fieldConfig) || devAssert2(
      false,
      `${config.name}.${fieldName} field config must be an object.`
    );
    fieldConfig.resolve == null || typeof fieldConfig.resolve === "function" || devAssert2(
      false,
      `${config.name}.${fieldName} field resolver must be a function if provided, but got: ${inspect2(fieldConfig.resolve)}.`
    );
    const argsConfig = (_fieldConfig$args = fieldConfig.args) !== null && _fieldConfig$args !== void 0 ? _fieldConfig$args : {};
    isPlainObj2(argsConfig) || devAssert2(
      false,
      `${config.name}.${fieldName} args must be an object with argument names as keys.`
    );
    return {
      ...
      subscribe: fieldConfig.subscribe,
      deprecationReason: fieldConfig.deprecationReason,
      extensions: toObjMap2(fieldConfig.extensions),
      astNode: fieldConfig.astNode
    };
  });
}
function defineArguments2(config) {
  return Object.entries(config).map(([argName, argConfig]) => ({
    ...
    defaultValue: argConfig.defaultValue,
    deprecationReason: argConfig.deprecationReason,
    extensions: toObjMap2(argConfig.extensions),
    astNode: argConfig.astNode
  }));
}
...
var GraphQLInterfaceType2 = class {
  constructor(config) {
    ...
    config.resolveType == null || typeof config.resolveType === "function" || devAssert2(
      false,
      `${this.name} must provide "resolveType" as a function, but got: ${inspect2(config.resolveType)}.`
    );
  }
  get [Symbol.toStringTag]() {
    return "GraphQLInterfaceType";
...
function defineTypes2(config) {
  ...
  Array.isArray(types) || devAssert2(
    false,
    `Must provide Array of types or a function which returns such an array for Union ${config.name}.`
  );
  return types;
...
var GraphQLEnumType2 = class {
  constructor(config) {
    ...
    this._nameLookup = keyMap2(this._values, (value) => value.name);
  }
  get [Symbol.toStringTag]() {
    return "GraphQLEnumType";
  }
  ...
  serialize(outputValue) {
    ...
    if (enumValue === void 0) {
      throw new GraphQLError2(
        `Enum "${this.name}" cannot represent value: ${inspect2(outputValue)}`
      );
    }
    return enumValue.name;
  }
  parseValue(inputValue) {
    if (typeof inputValue !== "string") {
      const valueStr = inspect2(inputValue);
      throw new GraphQLError2(
...
function didYouMeanEnumValue2(enumType, unknownValueStr) {
  const allNames = enumType.getValues().map((value) => value.name);
  const suggestedValues = suggestionList2(unknownValueStr, allNames);
  return didYouMean2("the enum value", suggestedValues);
}
function defineEnumValues2(typeName, valueMap) {
  isPlainObj2(valueMap) || devAssert2(
    false,
    `${typeName} values must be an object with value names as keys.`
  );
  return Object.entries(valueMap).map(([valueName, valueConfig]) => {
    isPlainObj2(valueConfig) || devAssert2(
      false,
      `${typeName}.${valueName} must refer to an object with a "value" key representing an internal value but got: ${inspect2(valueConfig)}.`
    );
    return {
      name: assertEnumValueName2(valueName),
      description: valueConfig.description,
      value: valueConfig.value !== void 0 ? valueConfig.value : valueName,
      deprecationReason: valueConfig.deprecationReason,
      extensions: toObjMap2(valueConfig.extensions),
      astNode: valueConfig.astNode
    };
  });
}
var GraphQLInputObjectType2 = class {
  ...
  toConfig() {
    const fields = mapValue2(this.getFields(), (field) => ({
      description: field.description,
      type: field.type,
      defaultValue: field.defaultValue,
      deprecationReason: field.deprecationReason,
...
function defineInputFieldMap2(config) {
  ...
  return mapValue2(fieldMap, (fieldConfig, fieldName) => {
    !("resolve" in fieldConfig) || devAssert2(
      false,
      `${config.name}.${fieldName} field has a resolve property, but Input Types cannot define resolvers.`
    );
    return {
...
// ../../node_modules/graphql-tag/node_modules/graphql/utilities/typeComparators.mjs
function isTypeSubTypeOf2(schema, maybeSubType, superType) {
  if (maybeSubType === superType) {
    return true;
  }
  if (isNonNullType2(superType)) {
    if (isNonNullType2(maybeSubType)) {
  ...
  if (isListType2(superType)) {
    if (isListType2(maybeSubType)) {
      return isTypeSubTypeOf2(schema, maybeSubType.ofType, superType.ofType);
    }
    return false;
  }
  ...
  return isAbstractType2(superType) && (isInterfaceType2(maybeSubType) || isObjectType2(maybeSubType)) && schema.isSubType(superType, maybeSubType);
}
function doTypesOverlap2(schema, typeA, typeB) {
  if (typeA === typeB) {
    return true;
  }
  if (isAbstractType2(typeA)) {
    if (isAbstractType2(typeB)) {
      return schema.getPossibleTypes(typeA).some((type) => schema.isSubType(typeB, type));
    }
    return schema.isSubType(typeA, typeB);
  }
...
// ../../node_modules/graphql-tag/node_modules/graphql/type/scalars.mjs
var GRAPHQL_MAX_INT2 = 2147483647;
var GRAPHQL_MIN_INT2 = -2147483648;
var GraphQLInt2 = new GraphQLScalarType2({
  name: "Int",
  description: "The `Int` scalar type represents non-fractional signed whole numeric values. Int can represent values between -(2^31) and 2^31 - 1.",
  serialize(outputValue) {
    ...
    if (typeof num !== "number" || !Number.isInteger(num)) {
      throw new GraphQLError2(
        `Int cannot represent non-integer value: ${inspect2(coercedValue)}`
      );
    }
    if (num > GRAPHQL_MAX_INT2 || num < GRAPHQL_MIN_INT2) {
      throw new GraphQLError2(
        "Int cannot represent non 32-bit signed integer value: " + inspect2(coercedValue)
      );
    }
    return num;
  },
  parseValue(inputValue) {
    if (typeof inputValue !== "number" || !Number.isInteger(inputValue)) {
      throw new GraphQLError2(
        `Int cannot represent non-integer value: ${inspect2(inputValue)}`
      );
    }
...
var GraphQLFloat2 = new GraphQLScalarType2({
  name: "Float",
  description: "The `Float` scalar type represents signed double-precision fractional values as specified by [IEEE 754](https://en.wikipedia.org/wiki/IEEE_floating_point).",
  serialize(outputValue) {
    const coercedValue = serializeObject2(outputValue);
    ...
    if (typeof num !== "number" || !Number.isFinite(num)) {
      throw new GraphQLError2(
        `Float cannot represent non numeric value: ${inspect2(coercedValue)}`
      );
    }
    return num;
  },
  parseValue(inputValue) {
    if (typeof inputValue !== "number" || !Number.isFinite(inputValue)) {
      throw new GraphQLError2(
        `Float cannot represent non numeric value: ${inspect2(inputValue)}`
      );
    }
    return inputValue;
  },
...
var GraphQLString2 = new GraphQLScalarType2({
  name: "String",
  description: "The `String` scalar type represents textual data, represented as UTF-8 character sequences. The String type is most often used by GraphQL to represent free-form human-readable text.",
  serialize(outputValue) {
    const coercedValue = serializeObject2(outputValue);
    ...
    throw new GraphQLError2(
      `String cannot represent value: ${inspect2(outputValue)}`
    );
  },
  parseValue(inputValue) {
    if (typeof inputValue !== "string") {
      throw new GraphQLError2(
        `String cannot represent a non string value: ${inspect2(inputValue)}`
      );
    }
    return inputValue;
  },
...
var GraphQLBoolean2 = new GraphQLScalarType2({
  name: "Boolean",
  description: "The `Boolean` scalar type represents `true` or `false`.",
  serialize(outputValue) {
    const coercedValue = serializeObject2(outputValue);
    ...
    throw new GraphQLError2(
      `Boolean cannot represent a non boolean value: ${inspect2(coercedValue)}`
    );
  },
  parseValue(inputValue) {
    if (typeof inputValue !== "boolean") {
      throw new GraphQLError2(
        `Boolean cannot represent a non boolean value: ${inspect2(inputValue)}`
      );
    }
    return inputValue;
  },
...
var GraphQLID2 = new GraphQLScalarType2({
  name: "ID",
  description: 'The `ID` scalar type represents a unique identifier, often used to refetch an object or as key for a cache. The ID type appears in a JSON response as a String; however, it is not intended to be human-readable. When expected as an input type, any string (such as `"4"`) or integer (such as `4`) input value will be accepted as an ID.',
  serialize(outputValue) {
    const coercedValue = serializeObject2(outputValue);
    ...
    throw new GraphQLError2(
      `ID cannot represent value: ${inspect2(outputValue)}`
    );
  },
  parseValue(inputValue) {
    if (typeof inputValue === "string") {
    ...
    throw new GraphQLError2(`ID cannot represent value: ${inspect2(inputValue)}`);
  },
  parseLiteral(valueNode) {
...
function serializeObject2(outputValue) {
  if (isObjectLike2(outputValue)) {
    if (typeof outputValue.valueOf === "function") {
      const valueOfResult = outputValue.valueOf();
      if (!isObjectLike2(valueOfResult)) {
        return valueOfResult;
      }
    }
    if (typeof outputValue.toJSON === "function") {
...
// ../../node_modules/graphql-tag/node_modules/graphql/type/directives.mjs
function isDirective2(directive) {
  return instanceOf4(directive, GraphQLDirective2);
}
var GraphQLDirective2 = class {
  constructor(config) {
    ...
    this.extensions = toObjMap2(config.extensions);
    this.astNode = config.astNode;
    Array.isArray(config.locations) || devAssert2(false, `@${config.name} locations must be an Array.`);
    const args = (_config$args = config.args) !== null && _config$args !== void 0 ? _config$args : {};
    isObjectLike2(args) && !Array.isArray(args) || devAssert2(
      false,
      `@${config.name} args must be an object with argument names as keys.`
    );
    this.args = defineArguments2(args);
  }
  get [Symbol.toStringTag]() {
    return "GraphQLDirective";
  }
  toConfig() {
    return {
      ...
      description: this.description,
      locations: this.locations,
      args: argsToArgsConfig2(this.args),
      isRepeatable: this.isRepeatable,
      extensions: this.extensions,
      astNode: this.astNode
    };
...
var GraphQLIncludeDirective2 = new GraphQLDirective2({
  ...
  description: "Directs the executor to include this field or fragment only when the `if` argument is true.",
  locations: [
    DirectiveLocation2.FIELD,
    DirectiveLocation2.FRAGMENT_SPREAD,
    DirectiveLocation2.INLINE_FRAGMENT
  ],
  args: {
    if: {
      type: new GraphQLNonNull2(GraphQLBoolean2),
      description: "Included when true."
    }
  }
});
...
var GraphQLDeprecatedDirective2 = new GraphQLDirective2({
  ...
  description: "Marks an element of a GraphQL schema as no longer supported.",
  locations: [
    DirectiveLocation2.FIELD_DEFINITION,
    DirectiveLocation2.ARGUMENT_DEFINITION,
    DirectiveLocation2.INPUT_FIELD_DEFINITION,
    DirectiveLocation2.ENUM_VALUE
  ],
  args: {
    reason: {
      type: GraphQLString2,
...
var GraphQLSpecifiedByDirective2 = new GraphQLDirective2({
  name: "specifiedBy",
  description: "Exposes a URL that specifies the behavior of this scalar.",
  locations: [DirectiveLocation2.SCALAR],
  args: {
    url: {
      type: new GraphQLNonNull2(GraphQLString2),
      description: "The URL that specifies the behavior of this scalar."
    }
  }
});
...
// ../../node_modules/graphql-tag/node_modules/graphql/jsutils/isIterableObject.mjs
function isIterableObject2(maybeIterable) {
  return typeof maybeIterable === "object" && typeof (maybeIterable === null || maybeIterable === void 0 ? void 0 : maybeIterable[Symbol.iterator]) === "function";
}

// ../../node_modules/graphql-tag/node_modules/graphql/utilities/astFromValue.mjs
function astFromValue2(value, type) {
  ...
  if (isLeafType2(type)) {
    ...
    if (typeof serialized === "string") {
      ...
      if (type === GraphQLID2 && integerStringRegExp2.test(serialized)) {
        return {
          kind: Kind2.INT,
          value: serialized
        };
    ...
    throw new TypeError(`Cannot convert value to AST: ${inspect2(serialized)}.`);
  }
  invariant3(false, "Unexpected input type: " + inspect2(type));
}
var integerStringRegExp2 = /^-?(?:0|[1-9][0-9]*)$/;

// ../../node_modules/graphql-tag/node_modules/graphql/type/introspection.mjs
var __Schema2 = new GraphQLObjectType2({
  name: "__Schema",
  description: "A GraphQL Schema defines the capabilities of a GraphQL server. It exposes all available types and directives on the server, as well as the entry points for query, mutation, and subscription operations.",
  fields: () => ({
    description: {
    ...
    types: {
      description: "A list of all types supported by this server.",
      type: new GraphQLNonNull2(new GraphQLList2(new GraphQLNonNull2(__Type2))),
      resolve(schema) {
        return Object.values(schema.getTypeMap());
      }
    },
    queryType: {
      description: "The type that query operations will be rooted at.",
      type: new GraphQLNonNull2(__Type2),
      resolve: (schema) => schema.getQueryType()
    },
    mutationType: {
      description: "If this server supports mutation, the type that mutation operations will be rooted at.",
    ...
    directives: {
      ...
      type: new GraphQLNonNull2(
        new GraphQLList2(new GraphQLNonNull2(__Directive2))
      ),
      resolve: (schema) => schema.getDirectives()
    }
  })
});
var __Directive2 = new GraphQLObjectType2({
  name: "__Directive",
  description: "A Directive provides a way to describe alternate runtime execution and type validation behavior in a GraphQL document.\n\nIn some cases, you need to provide options to alter GraphQL's execution behavior in ways field arguments will not suffice, such as conditionally including or skipping a field. Directives provide this by describing additional information to the executor.",
  fields: () => ({
    name: {
    ...
    locations: {
      type: new GraphQLNonNull2(
        new GraphQLList2(new GraphQLNonNull2(__DirectiveLocation2))
      ),
      resolve: (directive) => directive.locations
    },
    args: {
      type: new GraphQLNonNull2(
        new GraphQLList2(new GraphQLNonNull2(__InputValue2))
      ),
      args: {
        includeDeprecated: {
...
var __DirectiveLocation2 = new GraphQLEnumType2({
  name: "__DirectiveLocation",
  description: "A Directive can be adjacent to many parts of the GraphQL language, a __DirectiveLocation describes one such possible adjacencies.",
  values: {
    QUERY: {
...
var __Type2 = new GraphQLObjectType2({
  name: "__Type",
  description: "The fundamental unit of any GraphQL Schema is the type. There are many kinds of types in GraphQL as represented by the `__TypeKind` enum.\n\nDepending on the kind of a type, certain fields describe information about that type. Scalar types provide no information beyond a name, description and optional `specifiedByURL`, while Enum types provide their values. Object and Interface types provide the fields they describe. Abstract types, Union and Interface, provide the Object types possible at runtime. List and NonNull types compose other types.",
  fields: () => ({
    kind: {
      type: new GraphQLNonNull2(__TypeKind2),
      resolve(type) {
        ...
        invariant3(false, `Unexpected type: "${inspect2(type)}".`);
      }
    },
    name: {
      type: GraphQLString2,
    ...
    fields: {
      type: new GraphQLList2(new GraphQLNonNull2(__Field2)),
      args: {
        includeDeprecated: {
          type: GraphQLBoolean2,
          defaultValue: false
    ...
    interfaces: {
      type: new GraphQLList2(new GraphQLNonNull2(__Type2)),
      resolve(type) {
        if (isObjectType2(type) || isInterfaceType2(type)) {
          return type.getInterfaces();
        }
    ...
    enumValues: {
      type: new GraphQLList2(new GraphQLNonNull2(__EnumValue2)),
      args: {
        includeDeprecated: {
          type: GraphQLBoolean2,
          defaultValue: false
    ...
    inputFields: {
      type: new GraphQLList2(new GraphQLNonNull2(__InputValue2)),
      args: {
        includeDeprecated: {
          type: GraphQLBoolean2,
          defaultValue: false
...
var __Field2 = new GraphQLObjectType2({
  name: "__Field",
  description: "Object and Interface types are described by a list of Fields, each of which has a name, potentially a list of arguments, and a return type.",
  fields: () => ({
    name: {
...
var __InputValue2 = new GraphQLObjectType2({
  name: "__InputValue",
  description: "Arguments provided to Fields or Directives and the input fields of an InputObject are represented as Input Values which describe their type and optionally a default value.",
  fields: () => ({
    name: {
...
var __EnumValue2 = new GraphQLObjectType2({
  name: "__EnumValue",
  description: "One possible value for a given Enum. Enum values are unique values, not a placeholder for a string or numeric value. However an Enum value is returned in a JSON response as a string.",
  fields: () => ({
    name: {
...
var __TypeKind2 = new GraphQLEnumType2({
  name: "__TypeKind",
  description: "An enum describing what kind of type a given `__Type` is.",
  values: {
    SCALAR: {
...
var SchemaMetaFieldDef2 = {
  name: "__schema",
  type: new GraphQLNonNull2(__Schema2),
  description: "Access the current type schema of this server.",
  args: [],
  resolve: (_source, _args, _context, { schema }) => schema,
  deprecationReason: void 0,
...
// ../../node_modules/graphql-tag/node_modules/graphql/type/schema.mjs
var GraphQLSchema2 = class {
  constructor(config) {
    var _config$extensionASTN, _config$directives;
    this.__validationErrors = config.assumeValid === true ? [] : void 0;
    isObjectLike2(config) || devAssert2(false, "Must provide configuration object.");
    !config.types || Array.isArray(config.types) || devAssert2(
      false,
      `"types" must be Array if provided but got: ${inspect2(config.types)}.`
    );
    !config.directives || Array.isArray(config.directives) || devAssert2(
      false,
      `"directives" must be Array if provided but got: ${inspect2(config.directives)}.`
    );
    this.description = config.description;
    this.extensions = toObjMap2(config.extensions);
    this.astNode = config.astNode;
    ...
    this._mutationType = config.mutation;
    this._subscriptionType = config.subscription;
    this._directives = (_config$directives = config.directives) !== null && _config$directives !== void 0 ? _config$directives : specifiedDirectives2;
    const allReferencedTypes = new Set(config.types);
    if (config.types != null) {
      for (const type of config.types) {
        allReferencedTypes.delete(type);
    ...
    collectReferencedTypes2(__Schema2, allReferencedTypes);
    this._typeMap = /* @__PURE__ */ Object.create(null);
    this._subTypeMap = /* @__PURE__ */ Object.create(null);
    this._implementationsMap = /* @__PURE__ */ Object.create(null);
    for (const namedType of allReferencedTypes) {
      ...
      this._typeMap[typeName] = namedType;
      if (isInterfaceType2(namedType)) {
        for (const iface of namedType.getInterfaces()) {
          if (isInterfaceType2(iface)) {
            let implementations = this._implementationsMap[iface.name];
            if (implementations === void 0) {
              implementations = this._implementationsMap[iface.name] = {
                objects: [],
      ...
      } else if (isObjectType2(namedType)) {
        for (const iface of namedType.getInterfaces()) {
          if (isInterfaceType2(iface)) {
            let implementations = this._implementationsMap[iface.name];
            if (implementations === void 0) {
  ...
  getRootType(operation) {
    switch (operation) {
      case OperationTypeNode2.QUERY:
        return this.getQueryType();
      case OperationTypeNode2.MUTATION:
        return this.getMutationType();
      case OperationTypeNode2.SUBSCRIPTION:
        return this.getSubscriptionType();
    }
  }
  getTypeMap() {
  ...
  getPossibleTypes(abstractType) {
    return isUnionType2(abstractType) ? abstractType.getTypes() : this.getImplementations(abstractType).objects;
  }
  getImplementations(interfaceType) {
    const implementations = this._implementationsMap[interfaceType.name];
    return implementations !== null && implementations !== void 0 ? implementations : {
...
function collectReferencedTypes2(type, typeSet) {
  ...
  if (!typeSet.has(namedType)) {
    typeSet.add(namedType);
    if (isUnionType2(namedType)) {
      for (const memberType of namedType.getTypes()) {
        collectReferencedTypes2(memberType, typeSet);
      }
    } else if (isObjectType2(namedType) || isInterfaceType2(namedType)) {
      for (const interfaceType of namedType.getInterfaces()) {
    ...
    } else if (isInputObjectType2(namedType)) {
      for (const field of Object.values(namedType.getFields())) {
        collectReferencedTypes2(field.type, typeSet);
      }
    }
...
// ../../node_modules/graphql-tag/node_modules/graphql/utilities/typeFromAST.mjs
...
// ../../node_modules/graphql-tag/node_modules/graphql/utilities/TypeInfo.mjs
var TypeInfo2 = class {
  constructor(schema, initialType, getFieldDefFn) {
    this._schema = schema;
    this._typeStack = [];
    ...
    if (initialType) {
      if (isInputType2(initialType)) {
        this._inputTypeStack.push(initialType);
      }
      if (isCompositeType2(initialType)) {
        this._parentTypeStack.push(initialType);
      }
      if (isOutputType2(initialType)) {
        this._typeStack.push(initialType);
      }
    }
  }
  ...
  enter(node) {
    ...
    switch (node.kind) {
      case Kind2.SELECTION_SET: {
        const namedType = getNamedType2(this.getType());
        this._parentTypeStack.push(
          isCompositeType2(namedType) ? namedType : void 0
        );
        break;
      }
      case Kind2.FIELD: {
        ...
        this._fieldDefStack.push(fieldDef);
        this._typeStack.push(isOutputType2(fieldType) ? fieldType : void 0);
        break;
      }
      ...
      case Kind2.OPERATION_DEFINITION: {
        const rootType = schema.getRootType(node.operation);
        this._typeStack.push(isObjectType2(rootType) ? rootType : void 0);
        break;
      }
      case Kind2.INLINE_FRAGMENT:
      case Kind2.FRAGMENT_DEFINITION: {
        const typeConditionAST = node.typeCondition;
        const outputType = typeConditionAST ? typeFromAST2(schema, typeConditionAST) : getNamedType2(this.getType());
        this._typeStack.push(isOutputType2(outputType) ? outputType : void 0);
        break;
      }
      case Kind2.VARIABLE_DEFINITION: {
        const inputType = typeFromAST2(schema, node.type);
        this._inputTypeStack.push(
          isInputType2(inputType) ? inputType : void 0
        );
        break;
      }
      case Kind2.ARGUMENT: {
        ...
        this._argument = argDef;
        this._defaultValueStack.push(argDef ? argDef.defaultValue : void 0);
        this._inputTypeStack.push(isInputType2(argType) ? argType : void 0);
        break;
      }
      case Kind2.LIST: {
        const listType = getNullableType2(this.getInputType());
        const itemType = isListType2(listType) ? listType.ofType : listType;
        this._defaultValueStack.push(void 0);
        this._inputTypeStack.push(isInputType2(itemType) ? itemType : void 0);
        break;
      }
      case Kind2.OBJECT_FIELD: {
        const objectType = getNamedType2(this.getInputType());
        let inputFieldType;
        let inputField;
        if (isInputObjectType2(objectType)) {
          inputField = objectType.getFields()[node.name.value];
          if (inputField) {
            inputFieldType = inputField.type;
          }
        ...
        this._inputTypeStack.push(
          isInputType2(inputFieldType) ? inputFieldType : void 0
        );
        break;
      }
      case Kind2.ENUM: {
        const enumType = getNamedType2(this.getInputType());
        let enumValue;
        if (isEnumType2(enumType)) {
          enumValue = enumType.getValue(node.value);
        }
        this._enumValue = enumValue;
        break;
...
function getFieldDef3(schema, parentType, fieldNode) {
  const name = fieldNode.name.value;
  if (name === SchemaMetaFieldDef2.name && schema.getQueryType() === parentType) {
    return SchemaMetaFieldDef2;
  }
  if (name === TypeMetaFieldDef2.name && schema.getQueryType() === parentType) {
    return TypeMetaFieldDef2;
  }
  if (name === TypeNameMetaFieldDef2.name && isCompositeType2(parentType)) {
    return TypeNameMetaFieldDef2;
  }
  if (isObjectType2(parentType) || isInterfaceType2(parentType)) {
    return parentType.getFields()[name];
  }
}
function visitWithTypeInfo2(typeInfo, visitor) {
  return {
    enter(...args) {
      const node = args[0];
      typeInfo.enter(node);
      const fn = getEnterLeaveForKind2(visitor, node.kind).enter;
      if (fn) {
        const result2 = fn.apply(visitor, args);
        if (result2 !== void 0) {
          typeInfo.leave(node);
    ...
    leave(...args) {
      const node = args[0];
      const fn = getEnterLeaveForKind2(visitor, node.kind).leave;
      let result2;
      if (fn) {
        result2 = fn.apply(visitor, args);
      }
...
// ../../node_modules/graphql-tag/node_modules/graphql/language/predicates.mjs
...
function isTypeSystemDefinitionNode2(node) {
  return node.kind === Kind2.SCHEMA_DEFINITION || isTypeDefinitionNode2(node) || node.kind === Kind2.DIRECTIVE_DEFINITION;
}
...
function isTypeSystemExtensionNode2(node) {
  return node.kind === Kind2.SCHEMA_EXTENSION || isTypeExtensionNode2(node);
}
...
// ../../node_modules/graphql-tag/node_modules/graphql/validation/rules/ExecutableDefinitionsRule.mjs
function ExecutableDefinitionsRule2(context) {
  return {
    Document(node) {
      for (const definition of node.definitions) {
        if (!isExecutableDefinitionNode2(definition)) {
...
// ../../node_modules/graphql-tag/node_modules/graphql/validation/rules/FieldsOnCorrectTypeRule.mjs
    ...
    Field(node) {
      ...
      if (type) {
        ...
        if (!fieldDef) {
          const schema = context.getSchema();
          const fieldName = node.name.value;
          let suggestion = didYouMean2(
            "to use an inline fragment on",
            getSuggestedTypeNames2(schema, type, fieldName)
          );
          if (suggestion === "") {
            suggestion = didYouMean2(getSuggestedFieldNames2(type, fieldName));
          }
          context.reportError(
            new GraphQLError2(
              `Cannot query field "${fieldName}" on type "${type.name}".` + suggestion,
...
function getSuggestedTypeNames2(schema, type, fieldName) {
  ...
  return [...suggestedTypes].sort((typeA, typeB) => {
    ...
    if (isInterfaceType2(typeA) && schema.isSubType(typeA, typeB)) {
      return -1;
    }
    if (isInterfaceType2(typeB) && schema.isSubType(typeB, typeA)) {
      return 1;
    }
    return naturalCompare2(typeA.name, typeB.name);
  }).map((x) => x.name);
}
function getSuggestedFieldNames2(type, fieldName) {
  if (isObjectType2(type) || isInterfaceType2(type)) {
    const possibleFieldNames = Object.keys(type.getFields());
    return suggestionList2(fieldName, possibleFieldNames);
  }
  return [];
}

// ../../node_modules/graphql-tag/node_modules/graphql/validation/rules/FragmentsOnCompositeTypesRule.mjs
...
// ../../node_modules/graphql-tag/node_modules/graphql/validation/rules/KnownArgumentNamesRule.mjs
function KnownArgumentNamesRule2(context) {
  return {
    ...KnownArgumentNamesOnDirectivesRule2(context),
    Argument(argNode) {
      const argDef = context.getArgument();
      const fieldDef = context.getFieldDef();
      const parentType = context.getParentType();
      if (!argDef && fieldDef && parentType) {
        const argName = argNode.name.value;
        const knownArgsNames = fieldDef.args.map((arg) => arg.name);
        const suggestions = suggestionList2(argName, knownArgsNames);
        context.reportError(
          new GraphQLError2(
            `Unknown argument "${argName}" on field "${parentType.name}.${fieldDef.name}".` + didYouMean2(suggestions),
            argNode
          )
        );
      }
...
function KnownArgumentNamesOnDirectivesRule2(context) {
  const directiveArgs = /* @__PURE__ */ Object.create(null);
  const schema = context.getSchema();
  const definedDirectives = schema ? schema.getDirectives() : specifiedDirectives2;
  for (const directive of definedDirectives) {
    directiveArgs[directive.name] = directive.args.map((arg) => arg.name);
  }
  const astDefinitions = context.getDocument().definitions;
    ...
    Directive(directiveNode) {
      ...
      if (directiveNode.arguments && knownArgs) {
        for (const argNode of directiveNode.arguments) {
          const argName = argNode.name.value;
          if (!knownArgs.includes(argName)) {
            const suggestions = suggestionList2(argName, knownArgs);
            context.reportError(
              new GraphQLError2(
                `Unknown argument "${argName}" on directive "@${directiveName}".` + didYouMean2(suggestions),
                argNode
              )
            );
          }
...
// ../../node_modules/graphql-tag/node_modules/graphql/validation/rules/KnownDirectivesRule.mjs
function KnownDirectivesRule2(context) {
  ...
  return {
    Directive(node, _key, _parent, _path, ancestors) {
      ...
      if (!locations) {
        context.reportError(
          new GraphQLError2(`Unknown directive "@${name}".`, node)
        );
        return;
      }
...
function getDirectiveLocationForASTPath2(ancestors) {
  ...
  switch (appliedTo.kind) {
    ...
    case Kind2.FIELD:
      return DirectiveLocation2.FIELD;
    case Kind2.FRAGMENT_SPREAD:
      return DirectiveLocation2.FRAGMENT_SPREAD;
    case Kind2.INLINE_FRAGMENT:
      return DirectiveLocation2.INLINE_FRAGMENT;
    case Kind2.FRAGMENT_DEFINITION:
      return DirectiveLocation2.FRAGMENT_DEFINITION;
    case Kind2.VARIABLE_DEFINITION:
      return DirectiveLocation2.VARIABLE_DEFINITION;
    case Kind2.SCHEMA_DEFINITION:
    case Kind2.SCHEMA_EXTENSION:
      return DirectiveLocation2.SCHEMA;
    case Kind2.SCALAR_TYPE_DEFINITION:
    case Kind2.SCALAR_TYPE_EXTENSION:
      return DirectiveLocation2.SCALAR;
    case Kind2.OBJECT_TYPE_DEFINITION:
    case Kind2.OBJECT_TYPE_EXTENSION:
      return DirectiveLocation2.OBJECT;
    case Kind2.FIELD_DEFINITION:
      return DirectiveLocation2.FIELD_DEFINITION;
    case Kind2.INTERFACE_TYPE_DEFINITION:
    case Kind2.INTERFACE_TYPE_EXTENSION:
      return DirectiveLocation2.INTERFACE;
    case Kind2.UNION_TYPE_DEFINITION:
    case Kind2.UNION_TYPE_EXTENSION:
      return DirectiveLocation2.UNION;
    case Kind2.ENUM_TYPE_DEFINITION:
    case Kind2.ENUM_TYPE_EXTENSION:
      return DirectiveLocation2.ENUM;
    case Kind2.ENUM_VALUE_DEFINITION:
      return DirectiveLocation2.ENUM_VALUE;
    case Kind2.INPUT_OBJECT_TYPE_DEFINITION:
    case Kind2.INPUT_OBJECT_TYPE_EXTENSION:
      return DirectiveLocation2.INPUT_OBJECT;
    case Kind2.INPUT_VALUE_DEFINITION: {
      const parentNode = ancestors[ancestors.length - 3];
      "kind" in parentNode || invariant3(false);
      return parentNode.kind === Kind2.INPUT_OBJECT_TYPE_DEFINITION ? DirectiveLocation2.INPUT_FIELD_DEFINITION : DirectiveLocation2.ARGUMENT_DEFINITION;
    }
    default:
      invariant3(false, "Unexpected kind: " + inspect2(appliedTo.kind));
  }
}
function getDirectiveLocationForOperation2(operation) {
  switch (operation) {
    case OperationTypeNode2.QUERY:
      return DirectiveLocation2.QUERY;
    case OperationTypeNode2.MUTATION:
      return DirectiveLocation2.MUTATION;
    case OperationTypeNode2.SUBSCRIPTION:
      return DirectiveLocation2.SUBSCRIPTION;
  }
}

// ../../node_modules/graphql-tag/node_modules/graphql/validation/rules/KnownFragmentNamesRule.mjs
function KnownFragmentNamesRule2(context) {
  return {
    FragmentSpread(node) {
      ...
      if (!fragment) {
        context.reportError(
          new GraphQLError2(`Unknown fragment "${fragmentName}".`, node.name)
        );
      }
    }
  };
...
// ../../node_modules/graphql-tag/node_modules/graphql/validation/rules/KnownTypeNamesRule.mjs
function KnownTypeNamesRule2(context) {
  const schema = context.getSchema();
  const existingTypesMap = schema ? schema.getTypeMap() : /* @__PURE__ */ Object.create(null);
  const definedTypes = /* @__PURE__ */ Object.create(null);
  for (const def of context.getDocument().definitions) {
    if (isTypeDefinitionNode2(def)) {
      definedTypes[def.name.value] = true;
    }
  }
  const typeNames = [
  ...
  return {
    NamedType(node, _1, parent, _2, ancestors) {
      ...
      if (!existingTypesMap[typeName] && !definedTypes[typeName]) {
        ...
        const suggestedTypes = suggestionList2(
          typeName,
          isSDL ? standardTypeNames2.concat(typeNames) : typeNames
        );
        context.reportError(
          new GraphQLError2(
            `Unknown type "${typeName}".` + didYouMean2(suggestedTypes),
            node
          )
        );
      }
...
var standardTypeNames2 = [...specifiedScalarTypes2, ...introspectionTypes2].map(
  (type) => type.name
);
function isSDLNode2(value) {
  return "kind" in value && (isTypeSystemDefinitionNode2(value) || isTypeSystemExtensionNode2(value));
}

// ../../node_modules/graphql-tag/node_modules/graphql/validation/rules/LoneAnonymousOperationRule.mjs
...
// ../../node_modules/graphql-tag/node_modules/graphql/validation/rules/LoneSchemaDefinitionRule.mjs
function LoneSchemaDefinitionRule2(context) {
  ...
  return {
    SchemaDefinition(node) {
      ...
      if (schemaDefinitionsCount > 0) {
        context.reportError(
          new GraphQLError2("Must provide only one schema definition.", node)
        );
      }
      ++schemaDefinitionsCount;
    }
...
// ../../node_modules/graphql-tag/node_modules/graphql/validation/rules/NoFragmentCyclesRule.mjs
...
// ../../node_modules/graphql-tag/node_modules/graphql/validation/rules/NoUndefinedVariablesRule.mjs
...
// ../../node_modules/graphql-tag/node_modules/graphql/validation/rules/NoUnusedFragmentsRule.mjs
...
// ../../node_modules/graphql-tag/node_modules/graphql/validation/rules/NoUnusedVariablesRule.mjs
...
// ../../node_modules/graphql-tag/node_modules/graphql/utilities/sortValueNode.mjs
function sortValueNode2(valueNode) {
  switch (valueNode.kind) {
    case Kind2.OBJECT:
      return { ...valueNode, fields: sortFields2(valueNode.fields) };
    case Kind2.LIST:
      return { ...valueNode, values: valueNode.values.map(sortValueNode2) };
    case Kind2.INT:
    case Kind2.FLOAT:
    case Kind2.STRING:
    case Kind2.BOOLEAN:
...
function sortFields2(fields) {
  return fields.map((fieldNode) => ({
    ...
    (fieldA, fieldB) => naturalCompare2(fieldA.name.value, fieldB.name.value)
  );
}

// ../../node_modules/graphql-tag/node_modules/graphql/validation/rules/OverlappingFieldsCanBeMergedRule.mjs
...
function findConflict2(context, cachedFieldsAndFragmentNames, comparedFragmentPairs, parentFieldsAreMutuallyExclusive, responseName, field1, field2) {
  const [parentType1, node1, def1] = field1;
  const [parentType2, node2, def2] = field2;
  const areMutuallyExclusive = parentFieldsAreMutuallyExclusive || parentType1 !== parentType2 && isObjectType2(parentType1) && isObjectType2(parentType2);
  if (!areMutuallyExclusive) {
    const name1 = node1.name.value;
    const name2 = node2.name.value;
    if (name1 !== name2) {
  ...
  if (type1 && type2 && doTypesConflict2(type1, type2)) {
    return [
      [
        responseName,
        `they return conflicting types "${inspect2(type1)}" and "${inspect2(
          type2
        )}"`
      ],
      [node1],
...
function stringifyArguments2(fieldNode) {
  ...
  return print2(sortValueNode2(inputObjectWithArgs));
}
function doTypesConflict2(type1, type2) {
  if (isListType2(type1)) {
    return isListType2(type2) ? doTypesConflict2(type1.ofType, type2.ofType) : true;
  }
  if (isListType2(type2)) {
    return true;
  }
  if (isNonNullType2(type1)) {
    return isNonNullType2(type2) ? doTypesConflict2(type1.ofType, type2.ofType) : true;
  }
  if (isNonNullType2(type2)) {
    return true;
  }
  if (isLeafType2(type1) || isLeafType2(type2)) {
    return type1 !== type2;
  }
  return false;
}
...
// ../../node_modules/graphql-tag/node_modules/graphql/validation/rules/PossibleFragmentSpreadsRule.mjs
function PossibleFragmentSpreadsRule2(context) {
  return {
    InlineFragment(node) {
      const fragType = context.getType();
      const parentType = context.getParentType();
      if (isCompositeType2(fragType) && isCompositeType2(parentType) && !doTypesOverlap2(context.getSchema(), fragType, parentType)) {
        const parentTypeStr = inspect2(parentType);
        const fragTypeStr = inspect2(fragType);
        context.reportError(
          new GraphQLError2(
            `Fragment cannot be spread here as objects of type "${parentTypeStr}" can never be of type "${fragTypeStr}".`,
            node
    ...
    FragmentSpread(node) {
      ...
      const parentType = context.getParentType();
      if (fragType && parentType && !doTypesOverlap2(context.getSchema(), fragType, parentType)) {
        const parentTypeStr = inspect2(parentType);
        const fragTypeStr = inspect2(fragType);
        context.reportError(
          new GraphQLError2(
...
function getFragmentType2(context, name) {
  const frag = context.getFragment(name);
  if (frag) {
...
// ../../node_modules/graphql-tag/node_modules/graphql/validation/rules/PossibleTypeExtensionsRule.mjs
function PossibleTypeExtensionsRule2(context) {
  ...
  function checkExtension(node) {
    ...
    if (expectedKind) {
      ...
      const suggestedTypes = suggestionList2(typeName, allTypeNames);
      context.reportError(
        new GraphQLError2(
          `Cannot extend type "${typeName}" because it is not defined.` + didYouMean2(suggestedTypes),
          node.name
        )
      );
    }
...
function extensionKindToTypeName2(kind) {
  switch (kind) {
    ...
    case Kind2.INPUT_OBJECT_TYPE_EXTENSION:
      return "input object";
    default:
      invariant3(false, "Unexpected kind: " + inspect2(kind));
  }
}

// ../../node_modules/graphql-tag/node_modules/graphql/validation/rules/ProvidedRequiredArgumentsRule.mjs
function ProvidedRequiredArgumentsRule2(context) {
  return {
    ...ProvidedRequiredArgumentsOnDirectivesRule2(context),
    Field: {
      leave(fieldNode) {
        var _fieldNode$arguments;
        const fieldDef = context.getFieldDef();
        ...
        for (const argDef of fieldDef.args) {
          if (!providedArgs.has(argDef.name) && isRequiredArgument2(argDef)) {
            const argTypeStr = inspect2(argDef.type);
            context.reportError(
              new GraphQLError2(
                `Field "${fieldDef.name}" argument "${argDef.name}" of type "${argTypeStr}" is required, but it was not provided.`,
                fieldNode
...
function ProvidedRequiredArgumentsOnDirectivesRule2(context) {
  ...
  const requiredArgsMap = /* @__PURE__ */ Object.create(null);
  const schema = context.getSchema();
  const definedDirectives = (_schema$getDirectives = schema === null || schema === void 0 ? void 0 : schema.getDirectives()) !== null && _schema$getDirectives !== void 0 ? _schema$getDirectives : specifiedDirectives2;
  for (const directive of definedDirectives) {
    requiredArgsMap[directive.name] = keyMap2(
      directive.args.filter(isRequiredArgument2),
      (arg) => arg.name
    );
  }
  const astDefinitions = context.getDocument().definitions;
  for (const def of astDefinitions) {
    if (def.kind === Kind2.DIRECTIVE_DEFINITION) {
      var _def$arguments;
      const argNodes = (_def$arguments = def.arguments) !== null && _def$arguments !== void 0 ? _def$arguments : [];
      requiredArgsMap[def.name.value] = keyMap2(
    ...
    Directive: {
      leave(directiveNode) {
        ...
        if (requiredArgs) {
          ...
          for (const [argName, argDef] of Object.entries(requiredArgs)) {
            if (!argNodeMap.has(argName)) {
              const argType = isType2(argDef.type) ? inspect2(argDef.type) : print2(argDef.type);
              context.reportError(
                new GraphQLError2(
                  `Directive "@${directiveName}" argument "${argName}" of type "${argType}" is required, but it was not provided.`,
                  directiveNode
...
// ../../node_modules/graphql-tag/node_modules/graphql/validation/rules/ScalarLeafsRule.mjs
function ScalarLeafsRule2(context) {
  return {
    Field(node) {
      ...
      const selectionSet = node.selectionSet;
      if (type) {
        if (isLeafType2(getNamedType2(type))) {
          if (selectionSet) {
            const fieldName = node.name.value;
            const typeStr = inspect2(type);
            context.reportError(
              new GraphQLError2(
                `Field "${fieldName}" must not have a selection since type "${typeStr}" has no subfields.`,
                selectionSet
...
// ../../node_modules/graphql-tag/node_modules/graphql/utilities/valueFromAST.mjs
function valueFromAST2(valueNode, type, variables) {
  ...
  if (valueNode.kind === Kind2.VARIABLE) {
    ...
    const variableValue = variables[variableName];
    if (variableValue === null && isNonNullType2(type)) {
      return;
    }
    return variableValue;
  }
  ...
  if (isInputObjectType2(type)) {
    ...
    for (const field of Object.values(type.getFields())) {
      ...
      if (!fieldNode || isMissingVariable2(fieldNode.value, variables)) {
        if (field.defaultValue !== void 0) {
          coercedObj[field.name] = field.defaultValue;
        } else if (isNonNullType2(field.type)) {
          return;
        }
        continue;
      }
...
// ../../node_modules/graphql-tag/node_modules/graphql/execution/values.mjs
  ...
  for (const argDef of def.args) {
    ...
    if (!argumentNode) {
      if (argDef.defaultValue !== void 0) {
        ...
        throw new GraphQLError2(
          `Argument "${name}" of required type "${inspect2(argType)}" was not provided.`,
          node
        );
      }
      continue;
    ...
    if (valueNode.kind === Kind2.VARIABLE) {
      const variableName = valueNode.name.value;
      if (variableValues == null || !hasOwnProperty8(variableValues, variableName)) {
        if (argDef.defaultValue !== void 0) {
          coercedValues[name] = argDef.defaultValue;
        } else if (isNonNullType2(argType)) {
          throw new GraphQLError2(
            `Argument "${name}" of required type "${inspect2(argType)}" was provided the variable "$${variableName}" which was not provided a runtime value.`,
            valueNode
          );
        }
        continue;
    ...
    if (isNull && isNonNullType2(argType)) {
      throw new GraphQLError2(
        `Argument "${name}" of non-null type "${inspect2(argType)}" must not be null.`,
        valueNode
      );
    }
...
function hasOwnProperty8(obj, prop) {
  return Object.prototype.hasOwnProperty.call(obj, prop);
}

// ../../node_modules/graphql-tag/node_modules/graphql/execution/collectFields.mjs
...
function shouldIncludeNode2(variableValues, node) {
  const skip = getDirectiveValues2(GraphQLSkipDirective2, node, variableValues);
  if ((skip === null || skip === void 0 ? void 0 : skip.if) === true) {
    return false;
  }
  const include = getDirectiveValues2(
    GraphQLIncludeDirective2,
    node,
    variableValues
  );
...
function doesFragmentConditionMatch2(schema, fragment, type) {
  ...
  if (isAbstractType2(conditionalType)) {
    return schema.isSubType(conditionalType, type);
  }
  return false;
}
...
// ../../node_modules/graphql-tag/node_modules/graphql/validation/rules/SingleFieldSubscriptionsRule.mjs
...
// ../../node_modules/graphql-tag/node_modules/graphql/jsutils/groupBy.mjs
...
// ../../node_modules/graphql-tag/node_modules/graphql/validation/rules/UniqueArgumentDefinitionNamesRule.mjs
...
// ../../node_modules/graphql-tag/node_modules/graphql/validation/rules/UniqueArgumentNamesRule.mjs
...
// ../../node_modules/graphql-tag/node_modules/graphql/validation/rules/UniqueDirectiveNamesRule.mjs
...
// ../../node_modules/graphql-tag/node_modules/graphql/validation/rules/UniqueDirectivesPerLocationRule.mjs
  ...
  return {
    enter(node) {
      ...
      if (node.kind === Kind2.SCHEMA_DEFINITION || node.kind === Kind2.SCHEMA_EXTENSION) {
        seenDirectives = schemaDirectives;
      } else if (isTypeDefinitionNode2(node) || isTypeExtensionNode2(node)) {
        const typeName = node.name.value;
        seenDirectives = typeDirectivesMap[typeName];
        if (seenDirectives === void 0) {
          typeDirectivesMap[typeName] = seenDirectives = /* @__PURE__ */ Object.create(null);
...
// ../../node_modules/graphql-tag/node_modules/graphql/validation/rules/UniqueEnumValueNamesRule.mjs
function UniqueEnumValueNamesRule2(context) {
  ...
  function checkValueUniqueness(node) {
    ...
    for (const valueDef of valueNodes) {
      const valueName = valueDef.name.value;
      const existingType = existingTypeMap[typeName];
      if (isEnumType2(existingType) && existingType.getValue(valueName)) {
        context.reportError(
          new GraphQLError2(
            `Enum value "${typeName}.${valueName}" already exists in the schema. It cannot also be defined in this type extension.`,
            valueDef.name
...
// ../../node_modules/graphql-tag/node_modules/graphql/validation/rules/UniqueFieldDefinitionNamesRule.mjs
...
function hasField2(type, fieldName) {
  if (isObjectType2(type) || isInterfaceType2(type) || isInputObjectType2(type)) {
    return type.getFields()[fieldName] != null;
  }
  return false;
}

// ../../node_modules/graphql-tag/node_modules/graphql/validation/rules/UniqueFragmentNamesRule.mjs
...
// ../../node_modules/graphql-tag/node_modules/graphql/validation/rules/UniqueInputFieldNamesRule.mjs
...
// ../../node_modules/graphql-tag/node_modules/graphql/validation/rules/UniqueOperationNamesRule.mjs
...
// ../../node_modules/graphql-tag/node_modules/graphql/validation/rules/UniqueOperationTypesRule.mjs
...
// ../../node_modules/graphql-tag/node_modules/graphql/validation/rules/UniqueTypeNamesRule.mjs
...
// ../../node_modules/graphql-tag/node_modules/graphql/validation/rules/UniqueVariableNamesRule.mjs
...
// ../../node_modules/graphql-tag/node_modules/graphql/validation/rules/ValuesOfCorrectTypeRule.mjs
function ValuesOfCorrectTypeRule2(context) {
  return {
    ListValue(node) {
      const type = getNullableType2(context.getParentInputType());
      if (!isListType2(type)) {
    ...
    ObjectValue(node) {
      const type = getNamedType2(context.getInputType());
      if (!isInputObjectType2(type)) {
        isValidValueNode2(context, node);
        return false;
      }
      const fieldNodeMap = keyMap2(node.fields, (field) => field.name.value);
      for (const fieldDef of Object.values(type.getFields())) {
        const fieldNode = fieldNodeMap[fieldDef.name];
        if (!fieldNode && isRequiredInputField2(fieldDef)) {
          const typeStr = inspect2(fieldDef.type);
          context.reportError(
            new GraphQLError2(
              `Field "${type.name}.${fieldDef.name}" of required type "${typeStr}" was not provided.`,
              node
    ...
    ObjectField(node) {
      const parentType = getNamedType2(context.getParentInputType());
      const fieldType = context.getInputType();
      if (!fieldType && isInputObjectType2(parentType)) {
        const suggestions = suggestionList2(
          node.name.value,
          Object.keys(parentType.getFields())
        );
        context.reportError(
          new GraphQLError2(
            `Field "${node.name.value}" is not defined by type "${parentType.name}".` + didYouMean2(suggestions),
            node
          )
        );
      }
    ...
    NullValue(node) {
      ...
      if (isNonNullType2(type)) {
        context.reportError(
          new GraphQLError2(
            `Expected value of type "${inspect2(type)}", found ${print2(node)}.`,
            node
          )
        );
      }
...
function isValidValueNode2(context, node) {
  ...
  const type = getNamedType2(locationType);
  if (!isLeafType2(type)) {
    const typeStr = inspect2(locationType);
    context.reportError(
      new GraphQLError2(
  ...
  try {
    ...
    if (error instanceof GraphQLError2) {
      ...
      context.reportError(
        new GraphQLError2(
          `Expected value of type "${typeStr}", found ${print2(node)}; ` + error.message,
          node,
          void 0,
          void 0,
          void 0,
...
// ../../node_modules/graphql-tag/node_modules/graphql/validation/rules/VariablesAreInputTypesRule.mjs
function VariablesAreInputTypesRule2(context) {
  return {
    VariableDefinition(node) {
      const type = typeFromAST2(context.getSchema(), node.type);
      if (type !== void 0 && !isInputType2(type)) {
        const variableName = node.variable.name.value;
...
// ../../node_modules/graphql-tag/node_modules/graphql/validation/rules/VariablesInAllowedPositionRule.mjs
...
function allowedVariableUsage2(schema, varType, varDefaultValue, locationType, locationDefaultValue) {
  if (isNonNullType2(locationType) && !isNonNullType2(varType)) {
    ...
    const nullableLocationType = locationType.ofType;
    return isTypeSubTypeOf2(schema, varType, nullableLocationType);
  }
  return isTypeSubTypeOf2(schema, varType, locationType);
}

// ../../node_modules/graphql-tag/node_modules/graphql/validation/specifiedRules.mjs
var specifiedRules2 = Object.freeze([
  ExecutableDefinitionsRule2,
  UniqueOperationNamesRule2,
  LoneAnonymousOperationRule2,
  SingleFieldSubscriptionsRule2,
  KnownTypeNamesRule2,
  FragmentsOnCompositeTypesRule2,
  VariablesAreInputTypesRule2,
  ScalarLeafsRule2,
  FieldsOnCorrectTypeRule2,
  UniqueFragmentNamesRule2,
  KnownFragmentNamesRule2,
  NoUnusedFragmentsRule2,
  PossibleFragmentSpreadsRule2,
  NoFragmentCyclesRule2,
  UniqueVariableNamesRule2,
  NoUndefinedVariablesRule2,
  NoUnusedVariablesRule2,
  KnownDirectivesRule2,
  UniqueDirectivesPerLocationRule2,
  KnownArgumentNamesRule2,
  UniqueArgumentNamesRule2,
  ValuesOfCorrectTypeRule2,
  ProvidedRequiredArgumentsRule2,
  VariablesInAllowedPositionRule2,
  OverlappingFieldsCanBeMergedRule2,
  UniqueInputFieldNamesRule2
]);
var specifiedSDLRules2 = Object.freeze([
  LoneSchemaDefinitionRule2,
  UniqueOperationTypesRule2,
  UniqueTypeNamesRule2,
  UniqueEnumValueNamesRule2,
  UniqueFieldDefinitionNamesRule2,
  UniqueArgumentDefinitionNamesRule2,
  UniqueDirectiveNamesRule2,
  KnownTypeNamesRule2,
  KnownDirectivesRule2,
  UniqueDirectivesPerLocationRule2,
  PossibleTypeExtensionsRule2,
  KnownArgumentNamesOnDirectivesRule2,
  UniqueArgumentNamesRule2,
  UniqueInputFieldNamesRule2,
  ProvidedRequiredArgumentsOnDirectivesRule2
]);

// ../../node_modules/graphql-tag/node_modules/graphql/validation/ValidationContext.mjs
...
// ../../node_modules/graphql-tag/node_modules/graphql/jsutils/memoize3.mjs
...
// ../../node_modules/graphql-tag/node_modules/graphql/execution/execute.mjs
var collectSubfields4 = memoize32(
  (exeContext, returnType, fieldNodes) => collectSubfields3(
    exeContext.schema,
    exeContext.fragments,
    exeContext.variableValues,
    returnType,
...
// ../../node_modules/graphql-tag/node_modules/graphql/utilities/extendSchema.mjs
var stdTypeMap2 = keyMap2(
  [...specifiedScalarTypes2, ...introspectionTypes2],
  (type) => type.name
);

// ../../node_modules/graphql-tag/node_modules/graphql/utilities/findBreakingChanges.mjs
...
(function(BreakingChangeType3) {
  ...
  BreakingChangeType3["DIRECTIVE_REPEATABLE_REMOVED"] = "DIRECTIVE_REPEATABLE_REMOVED";
  BreakingChangeType3["DIRECTIVE_LOCATION_REMOVED"] = "DIRECTIVE_LOCATION_REMOVED";
})(BreakingChangeType2 || (BreakingChangeType2 = {}));
...
(function(DangerousChangeType3) {
  ...
  DangerousChangeType3["IMPLEMENTED_INTERFACE_ADDED"] = "IMPLEMENTED_INTERFACE_ADDED";
  DangerousChangeType3["ARG_DEFAULT_VALUE_CHANGE"] = "ARG_DEFAULT_VALUE_CHANGE";
})(DangerousChangeType2 || (DangerousChangeType2 = {}));
...
***************************************************************************** */
//# sourceMappingURL=chunk-IRQTPPZ7.js.map
