...
function createMotionComponent(_a) {
  ...
  function MotionComponent(props, externalRef) {
    ...
    return React2.createElement(
      ...
      features,
      React2.createElement(MotionContext.Provider, { value: context }, useRender(Component, props, projectionId, useMotionRef(visualState, context.visualElement, externalRef), visualState, config.isStatic))
    );
  }
...
function useAnimatedState(initialState) {
  var _a = __read((0, import_react47.useState)(initialState), 2), animationState = _a[0], setAnimationState = _a[1];
