...
var getDefaultBreadcrumb = function getDefaultBreadcrumb2(_ref2) {
  var currentSection = _ref2.currentSection, location = _ref2.location, pathSection = _ref2.pathSection;
  var match = matchPath({
    end: true,
    path: pathSection
  }, pathSection);
...
var getBreadcrumbMatch = function getBreadcrumbMatch2(_ref3) {
  var currentSection = _ref3.currentSection, disableDefaults = _ref3.disableDefaults, excludePaths = _ref3.excludePaths, location = _ref3.location, pathSection = _ref3.pathSection, branches = _ref3.branches;
  var breadcrumb;
...
// dep:use-react-router-breadcrumbs
var use_react_router_breadcrumbs_default = es_default;
export {
  use_react_router_breadcrumbs_default as default,
  getBreadcrumbs
};
