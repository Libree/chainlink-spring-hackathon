    ...
    <>
      ...
      <FormItem>
        <Label
          ...
          helpText={'What is the investment goal you want to achieve?'}
        />
        <Controller
          name={`actions.${actionIndex}.investmentGoal`}
          control={control}
          defaultValue=""
          rules={{
          }}
          render={({
            ...
            <>
              <ValueInput
                ...
                onBlur={onBlur}
                onChange={onChange}
                placeholder={'Get some yield without too much volatility'}
      ...
      <FormItem>
        <Label
          ...
          helpText={'Initial amount that will be deposit on the strategy'}
        />
        <Controller
          name={`actions.${actionIndex}.initialAmount`}
          control={control}
          defaultValue=""
          rules={{
      ...
      <FormItem>
        <Label
          ...
          helpText={'What is the risk tolerance?'}
        />
        <Controller
          name={`actions.${actionIndex}.riskTolerance`}
          control={control}
          defaultValue=""
          rules={{
          }}
      ...
      <FormItem>
        <Label
          ...
          helpText={'What assets should be included in the strategy (comma sepparated)'}
        />
        <Controller
          name={`actions.${actionIndex}.assets`}
          control={control}
          defaultValue=""
          rules={{
          }}
...
export default ConfigureStrategyForm;
